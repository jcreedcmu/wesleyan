...
postulate
  ...
  tB- : (c : Obj1) (a : oA (c , c)) → oB- (c , c) a
  mB-/red1 : (c d : Obj1) (f : Mor1 c d)
    (a : oA (c , d)) (b : oB- (c , d) (mA (f , f) a))  →
    (mB- (f , idm c) a (mB- (idm c , f) (mA (idm c , f) a) b))
    ↦ mB- (f , f) a b
  {-# REWRITE mB-/red1 #-}
  mB-/red2 : (c d : Obj1) (f : Mor1 c d)
    (a : oA (c , d)) (b : oB- (c , d) (mA (f , f) a))  →
    (mB- (idm d , f) a (mB- (f , idm d) (mA (f , idm d) a) b))
    ↦ mB- (f , f) a b
  {-# REWRITE mB-/red2 #-}
