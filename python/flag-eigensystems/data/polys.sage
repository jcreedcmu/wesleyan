...
{{{id=58|
p = poly41.polynomial(x).subs(a=0.1,b=0.22,c=0.35,d=0.9)
///
}}}
...
ps
///
t^4 + 3.14000000000000*t^3 + 2.53400000000000*t^2 - 0.398826000000000*t - 0.761831410000000
}}}

{{{id=67|
ps.real_roots()
///
[-1.48986256758909, -1.27792814854989, -0.845475289345349, 0.473266005484329]
}}}